...
RESULTS_FILE = RESULTS_DIR / "wider_cnn_metrics.csv"
MODELS_DIR = Path(__file__).resolve().parent.parent / "models"
BEST_MODEL_FILE = MODELS_DIR / "wider_cnn_best.pth"
FINAL_MODEL_FILE = MODELS_DIR / "wider_cnn_final.pth"
CONFIG_FILE = RESULTS_DIR / "wider_cnn_config.json"
...
if __name__ == "__main__":
    ...
    optimizer = optim.Adam(wider_cnn_model.parameters(), lr=LEARNING_RATE)
