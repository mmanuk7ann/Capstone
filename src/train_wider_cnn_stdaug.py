...
if __name__ == "__main__":
    ...
    RESULTS_FILE = RESULTS_DIR / f"wider_cnn_stdaug_seed{args.seed}_metrics.csv"
    BEST_MODEL_FILE = MODELS_DIR / f"wider_cnn_stdaug_seed{args.seed}_best.pth"
    FINAL_MODEL_FILE = MODELS_DIR / f"wider_cnn_stdaug_seed{args.seed}_final.pth"
    CONFIG_FILE = RESULTS_DIR / f"wider_cnn_stdaug_seed{args.seed}_config.json"
